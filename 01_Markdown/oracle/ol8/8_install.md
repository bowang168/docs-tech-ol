...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/8/install"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol8"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-Preface.html -->

## Preface

[Oracle Linux 8: Installing Oracle Linux](https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/) provides information about how to
install the Oracle Linux 8 release.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-PreparingToInstall.html -->
...
Linux release to the current major release version, use the Leapp utility. See [Oracle Linux 8: Upgrading Systems With Leapp](https://docs.oracle.com/en/operating-systems/oracle-linux/8/leapp/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-SystemRequirements.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-SystemConfiguration.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-DefaultDiskPartitionLayout.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-ObtainingInstallationImages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-PreparingInstallationMedia.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-CustomizingBootLoaderActions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-ConfiguringtheBootLoader.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-InstallationBootOptions.html -->
...
:   Specifies a web server as the location that contains everything needed to install the
    ...
    For example: `https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64`
...
inst.loglevel=level
:   Specifies the logging level for
    installation: `critical`, `debug`,
    `error`, `info`, or `warning`. The
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-InstallingOracleLinuxManually.html -->
...
- [Graphics mode](install-InstallingOracleLinuxinGraphicsMode.html#graphics-mode "The Installation Source window identifies the source image that you use to install Oracle Linux.Software selection refers to the profile or base environment to be used during the installation.The installation destination is used to configure the disks where Oracle Linux is installed. Even if you accept the default settings, you must still open the Installation Destination screen to clear the option's warning icon. In the event of a system crash, Kdump captures information that helps diagnose the cause. Because security policy isn't required on all systems, use the Security Policy screen only if you need to enforce a specific security policy as defined by the organization or by government regulations. The Root Password window lets you set the root account password. This option lets you configure a user's credentials to enable access to the system. You can optionally configure the user to have administrative privileges.") where a graphical user interface guides you through the
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-InstallingOracleLinuxinGraphicsMode.html -->
...
- [System](install-InstallingOracleLinuxinGraphicsMode.html#system-options "The installation destination is used to configure the disks where Oracle Linux is installed. Even if you accept the default settings, you must still open the Installation Destination screen to clear the option's warning icon. In the event of a system crash, Kdump captures information that helps diagnose the cause. Because security policy isn't required on all systems, use the Security Policy screen only if you need to enforce a specific security policy as defined by the organization or by government regulations.")
- [User Settings](install-InstallingOracleLinuxinGraphicsMode.html#user-options "The Root Password window lets you set the root account password. This option lets you configure a user's credentials to enable access to the system. You can optionally configure the user to have administrative privileges.")
...
To select the system's time zone, select an area on the map that
corresponds to where the system is. Or, you can select from the Region and City drop down
lists to specify that location.

To select the system's time zone, select the appropriate location from the
Region and City dropdown lists.

To specify time, time format, and date, select the appropriate buttons
at the bottom of the screen.

To enable NTP, switch the Network Time switch at
the upper right corner of the screen to `ON`. Select
Settings to display a dialog box, where you can configure NTP
servers for the system to use.

You can skip configuring NTP until later by using the Chrony suite. See [Oracle Linux 8: Setting Up Networking](https://docs.oracle.com/en/operating-systems/oracle-linux/8/network/). See also [Configure Chrony on Oracle Linux](https://docs.oracle.com/en/learn/ol-chrony/).
...
To install extra packages from other sources, use the Additional
repositories box to add those sources, and then provide the
necessary information about those sources in the text fields next to the box.
...
- [Security Profile](install-InstallingOracleLinuxinGraphicsMode.html#security_profile "Because security policy isn't required on all systems, use the Security Policy screen only if you need to enforce a specific security policy as defined by the organization or by government regulations.")
...
on the left side of the Network & Host Name window, then toggle the
...
Because security policy isn't required on all systems, use the Security Policy screen
only if you need to enforce a specific security policy as defined by the organization or by
government regulations.

Figure 3-11 Security Policy

Available policies are listed in the profile window. These security policies follow the
recommendations and guidelines that are defined by the Security Content Automation Protocol
(SCAP) standard. Select the security profile you want to enforce and ensure that the Apply
security policy is switched to `On`.

If you prefer not apply any security policy, toggle the switch to
`Off`.

For more information on SCAP policies and profiles, see [Oracle Linux 8: Using OpenSCAP for Security
Compliance](https://docs.oracle.com/en/operating-systems/oracle-linux/8/oscap/).

### User Settings

Under User Settings, you configure the following options:

- [Root Password](install-InstallingOracleLinuxinGraphicsMode.html#root_password "The Root Password window lets you set the root account password.")
- [User Creation](install-InstallingOracleLinuxinGraphicsMode.html#user_creation "This option lets you configure a user's credentials to enable access to the system. You can optionally configure the user to have administrative privileges.")

You must configure at least one of the options. For example, to enable only
the `root` account, create its password. Then select Done
to return to the Installation Summary screen where you can proceed with the installation. You
can add users to the system later.

#### Root Password

The Root Password window lets you set the root account password.

Figure 3-12 Setting the root password
...
- User name: Enter the username that
  ...
  SSH.
- Make this user administrator: Set
...
prompted. At the completion of the system reboot, the opening screen might prompt you to
accept the license agreement and provide the option to create extra users. You must at least
review and accept the license agreement to enable the Finish
Configuration button. Then sign in to the system according to the credentials
you previously set in User Settings.
...
`/usr/share/oraclelinux-release/EULA` after signing in.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-InstallinginTextMode.html -->
...
Figure 3-14 Text-Based Installation Menu
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-PostInstallationConfiguration.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-AutomatinganOracleLinuxInstallationbyUsingKickstart.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-AbouttheKickstartConfigurationFile.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-StartingtheKickstartInstallation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-InstallingUsingtheDriverUpdateDisk.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-InstallingaSystemWithaBtrfsrootFileSystem.html -->

## 6 Installing a System With a Btrfs root File System

Oracle Linux uses XFS as the default file system, but it also offers
other file systems such as ext2, ext4,  and shared file systems such as NFS and Samba.
...
For more information about file systems in Oracle Linux, see [Oracle Linux 8: Performing File System
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-UsingtheGUIInstaller.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-UsingtheTextInstaller.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-VerifyingtheBtrfsInstallation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-TroubleshootingOracleLinuxInstallations.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-TroubleshootingMenuOptions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-DebugandLogInformation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-CreatingaNetworkInstallationSetup.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-SettingUpanOracleLinuxNetworkInstallation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-ConfiguringPXEBootLoading.html -->
...
6. Create the `pxelinux.cfg/default` PXE configuration file.
   ...
   - `append` defines any parameters to append when loading the kernel,
     ...
     `https://yum.oracle.com/repo/OracleLinux/OL8/baseos/latest/x86_64` for
     ...
     subdirectory such as `pxelinux/OL8`, ensure you have the
...
6. Create the `/var/lib/tftpboot/efi/grub.cfg` boot loader
   ...
   such as `efi/OL8`, ensure you have the correct relative paths.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/install-SupportingDifferentKindsofClients.html -->
