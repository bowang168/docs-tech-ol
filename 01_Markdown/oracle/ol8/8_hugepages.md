...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol8"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-Preface.html -->

[Oracle Linux 8: Configuring Huge Pages](https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/)
provides information about configuring Oracle Linux 8 systems to use the kernel huge
page feature to increase the page size to improve the performance of applications that have large memory requirements.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/ref-copyright-ccbysa4.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/ref-conventions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/ref-doc-accessibility.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/ref-accessibility.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/ref-diversity.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-ConfiguringHugePages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-HugeTLBPages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-TransparentHugePages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-ConfiguringHugeTLBPages.html -->
...
- [Requesting HugeTLB Pages by Using Kernel Parameters at Boot Time](hugepage-RequestingHugeTLBPagesByUsingKernelParametersAtBootTime.html#osmanage-RequestingHugeTLBPagesByUsingKernelParametersAtBootTime)
- [Requesting HugeTLB Pages Using NUMA Node Specific Parameters Early in the Boot Process](hugepage-RequestingHugeTLBPagesUsingNUMANodeSpecificParametersEarlyInTheBootProcess.html#osmanage-RequestingHugeTLBPagesUsingNUMANodeSpecificParametersEarlyInTheBootProcess)
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-KernelBootParametersForHugeTLBPages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-RequestingHugeTLBPagesByUsingKernelParametersAtBootTime.html -->

The precise way to request huge pages at boot time depends upon the system's requirements.
The following procedure provides some guidance but isn't exclusive of other approaches to
configuring boot options.

The following procedure shows how to set default kernel command line options in your GRUB 2
...
For more information about configuring kernel command line options and GRUB 2 see [Oracle Linux 8: Managing Kernels and System Boot](https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/)

1. Edit the default kernel command line options in the system's GRUB 2
   configuration.

   Specify 1 GB size for kernel boot parameter `default_hugepagesz` and 2
   pairs of "`hugepagesz=<Size_num>G
   hugepages=Qty_num`" parameters for the two huge page
   pools.

   Append the following line to the kernel command line options in
   `/etc/default/grub`
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-RequestingHugeTLBPagesUsingNUMANodeSpecificParametersEarlyInTheBootProcess.html -->
...
For more information about using systemd units, see see [Oracle Linux 8: Managing the System With systemd](https://docs.oracle.com/en/operating-systems/oracle-linux/8/systemd/).
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-ConfiguringHugeTLBPagesForASpecificNUMANodeAtRuntime.html -->
...
Before starting, you must ensure you have the required administrative privileges required for
all the steps.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-ConfiguringTransparentHugePages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-ParametersUsedToConfigureTransparentHugePages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-RetrievingTheCurrentStatusOfTransparentHugePages.html -->

This procedure shows how to see the current status of THP in the `sysfs`
virtual file system.

For more information about using the `sysfs` virtual file system, see [Oracle Linux 8: Managing Kernels and System Boot](https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/)
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-ChangingTheCurrentStatusOfTransparentHugePages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/hugepages/hugepage-ChangingthedefragSettingofTransparentHugePages.html -->
