...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol8"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-Preface.html -->

## Preface

[Oracle Linux 8: Managing Kernels and System
Boot](https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/)
provides information about configuring the Oracle Linux 8 boot loader,
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-AbouttheBootProcess.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-AboutUEFIBasedBooting.html -->
...
6. The kernel searches for the `init` process within
   ...
   systemd](https://docs.oracle.com/en/operating-systems/oracle-linux/8/systemd/) for more information.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-AboutBIOSBasedBooting.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-AbouttheGRUB2Bootloader.html -->
...
name `machine_id-kernel_version.el8.arch.conf`.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-about_linux_kernels.html -->
...
[Oracle Linux 8 Kernel Reference](oracle_linux8_kernel_version_matrix.html "The information provided in this reference can help you to understand the different kernel versions that are available for Oracle Linux 8.")
.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-AboutKernelModules.html -->
...
For more information about external driver modules and driver update disks, see [Oracle Linux 8: Installing Oracle Linux](https://docs.oracle.com/en/operating-systems/oracle-linux/8/install/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-ConfiguringSystemSettings.html -->
...
:   Specifies default settings for the GRUB 2 bootloader. This file is a symbolic link to
    `/etc/default/grub`. For more information, see [About the GRUB 2 Bootloader](boot-AbouttheGRUB2Bootloader.html#ol-bootconf-grub2).
...
:   Defines a list of btrfs file systems and thinly provisioned
    ...
    For more information, see [Oracle Linux 8: Performing File System
...
[Oracle Linux 8: Managing System Devices With
udev](https://docs.oracle.com/en/operating-systems/oracle-linux/8/udev/) for more information about device management.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-ChangingKernelBootParametersBeforeBooting.html -->
...
You can edit the GRUB configuration after the system is booted. See [Changing GRUB 2 Default Kernel Boot Parameters](boot-ChangingGRUB2DefaultKernelBootParameters.html). A better approach is to use `grubby`. See 
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-ChangingGRUB2DefaultKernelBootParameters.html -->
...
The preferred approach to editing the GRUB 2 configuration files directly is to use `grubby`. See [Using grubby to Manage Kernels](boot-UsinggrubbyToManageKernels.html).

1. Edit `/etc/default/grub` to add kernel boot parameters.

   Edit `/etc/default/grub` and add parameter settings to the
   `GRUB_CMDLINE_LINUX` definition, for example:
   ...
   This example adds the parameter `systemd.unit=runlevel3.target` so that
   the system boots into multiuser, nongraphical mode by default.
...
For systems that boot with UEFI, the `grub.cfg` file is in the
`/boot/efi/EFI/redhat` directory because the boot configuration is
stored on a dedicated FAT32-formatted partition.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-UsinggrubbyToManageKernels.html -->

## 5 Using `grubby` to Manage Kernels
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-UsinggrubbyToManageKernels_check_available_kernels.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-UsinggrubbyToManageKernels_check_the_current_default_kernel.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-UsinggrubbyToManageKernels_change_the_default_kernel.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-UsinggrubbyToManageKernels_change_kernel_command_line_boot_parameters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-UsinggrubbyToManageKernels_check_last_kernel_cmdline.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-ModifyingKernelParameters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-list_all_configurable_kernel_parameters_and_values.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-updating_kernel_parameters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-ManagingKernelModules.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-ListingInformationAboutLoadedModules.html -->
...
- Use the `modinfo -n` command to find the file path to the module on
  ...
  ```
  /lib/modules/5.15.0-208.159.3.2.el8uek.x86_64/kernel/drivers/parport/parport.ko.xz
  ```


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-LoadingandUnloadingModules.html -->
...
- Load a kernel module using the `modprobe` command.
  ...
  ```
  insmod /lib/modules/5.15.0-208.159.3.2.el8uek.x86_64/kernel/net/sunrpc/auth_gss/auth_rpcgss.ko 
  insmod /lib/modules/5.15.0-208.159.3.2.el8uek.x86_64/kernel/fs/nfs_common/nfs_acl.ko 
  insmod /lib/modules/5.15.0-208.159.3.2.el8uek.x86_64/kernel/fs/fscache/fscache.ko 
  ...
  ```
...
- Unload a module by using the `modprobe -r` command.
  ...
  rmmod /lib/modules/5.15.0-208.159.3.2.el8uek.x86_64/kernel/fs/lockd/lockd.ko
  rmmod /lib/modules/5.15.0-208.159.3.2.el8uek.x86_64/kernel/fs/fscache/fscache.ko
  ...
  ```
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-ChangingKernelModuleOptions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-SpecifyingModulesToBeLoadedatBootTime.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-PreventingModulesFromLoadingatBootTime.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-RemovingWeakModules.html -->
...
1. Remove the symbolic link manually.
   ...
   ```
   sudo rm -rf /lib/modules/5.15.0-208.159.3.2.el8uek.x86_64/weak-updates/kmod-kvdo
   ```

   In this example, the weak update module, kmod-kvdo, is removed from
   the kernel, 5.15.0-208.159.3.2.el8uek.x86\_64.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-Managing_Resources_Cgroups.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/cgroups-EnableCGrp2.html -->

## Enabling cgroups v2

At boot time, Oracle Linux 8 mounts `cgroups v1` by default. To
use `cgroups v2`, you must manually configure the system.
...
1. Verify that `cgroups v2` is enabled and mounted on the system.
   ...
   If the output of the command doesn't specify `cgroup2`, then do the
   following to enable version 2.
   ...
   1. Configure the system boot to mount `cgroups v2` by default.
      ...
      The command adds `systemd.unified_cgroup_hierarchy=1` to the current
      boot entry. To add this parameter to all kernel boot entries, type:

      ```
      sudo grubby --update-kernel=ALL --args="systemd.unified_cgroup_hierarchy=1"
      ```
   2. Reboot the system.
   3. After the system reboots, verify that `cgroups v2` is now
      mounted.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/cgroups-ResourceControllers.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/cgroups-CGroupFileSystem.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/cgroups-ResourceDistModels.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/cgroups-CgroupsV2AppResMgt.html -->
...
We recommend that you use systemd to handle all resource management. See
[Oracle Linux 8: Managing the System With
systemd](https://docs.oracle.com/en/operating-systems/oracle-linux/8/systemd/) for more information. The
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-ConfigWatchdogServ.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/monitoring-WorkingWithKernelDumps.html -->
...
Kdump can also be used for troubleshooting in a cluster setup that uses the OCFS2 file
system. For more information, see Configuring the Behavior of Fenced Nodes With
Kdump in [Oracle Linux 8: Managing Shared File Systems](https://docs.oracle.com/en/operating-systems/oracle-linux/8/shareadmin/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/kdump_system_requirements.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/kdump-memory_reservation.html -->

## Kdump Memory Reservation

Kdump memory reservation is a feature in Linux that reserves part of system memory to
capture and store kernel crash dumps when a kernel panic occurs. By reserving memory,
Kdump always has enough space to collect and save critical information about the crash,
even if the rest of the system runs out of memory.
...
Memory reservations are made using the `crashkernel` kernel parameter. By
default, `crashkernel` reserves space in low memory. Low memory is the
...
`crashkernel=size`
:   First, the kernel searches low memory for the requested amount of space. If
    this fails, it looks for this space in high memory. If the reservation in
    high memory succeeds, it then tries to reserve the default amount of space
    (128 MB in arm64 systems) in low memory.

`crashkernel=size@offset`
:   Reserves size memory at the specified
    offset, or fails if already occupied.

`crashkernel=size,high crashkernel=size,low`
:   Reserves memory from both high and low memory. The kernel first searches for the amount of memory
    required in high memory. If the reservation succeeds in high memory, the
    kernel then tries to reserve the amount of low memory specified in
    `crashkernel=size,low`. If the
    reservation from high memory fails, the kernel searches low memory for
    the amount of memory specified in
    `crashkernel=size,high`.
    Setting `crashkernel=0,low` disables low memory
    allocation.
...
crashkernel=size,low` options to prefer
reservations in high memory on aarch64 systems.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/monitoring-InstallingKdump.html -->
...
- You understand how Kdump reserves memory and have made the appropriate memory
  reservation for the system. For details, see [Kdump Memory Reservation](kdump-memory_reservation.html#memory_reservation)
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/monitoring-ConfiguringKdump.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/monitoring-AnalyzingKdumpOutput.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/monitoring-UsingEarlyKdump.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/oracle_linux8_kernel_version_matrix.html -->

## 11 Oracle Linux 8 Kernel Reference
...
The following tables provide an overview of kernel availability on Oracle Linux 8
...
| --- | --- | --- | --- | --- |
| 8.10 | kernel-uek-5.15.0-206.153.7 | kernel-4.18.0-544 | Yes | Yes, default |
...
| 8.6 | kernel-uek-5.4.17-2136.307.3 | kernel-4.18.0-372.9.1 | Yes, default | Yes |
| 8.5 | kernel-uek-5.4.17-2136.300.7 | kernel-4.18.0-348 | Yes, default | Yes |
| 8.4 | kernel-uek-5.4.17-2102.201.3 | kernel-4.18.0-305 | Yes, default | No |
...
| --- | --- | --- |
| [UEK R7U3](https://docs.oracle.com/en/operating-systems/uek/7/relnotes7.3/) | 5.15.0-30\* | September, 2024 |
| [UEK R7U2](https://docs.oracle.com/en/operating-systems/uek/7/relnotes7.2/) | 5.15.0-20\* | October, 2023 |
| [UEK R7U1](https://docs.oracle.com/en/operating-systems/uek/7/relnotes7.1/) | 5.15.0-10\* | April, 2023 |
| [UEK R7](https://docs.oracle.com/en/operating-systems/uek/7/relnotes7.0/) | 5.15.0 | June, 2022 |
| [UEK R6U3](https://docs.oracle.com/en/operating-systems/uek/6/relnotes6.3/) | 5.4.17-2136 | October, 2021 |
| [UEK R6U2](https://docs.oracle.com/en/operating-systems/uek/6/relnotes6.2/) | 5.4.17-2102 | March, 2021 |
| [UEK R6U1](https://docs.oracle.com/en/operating-systems/uek/6/relnotes6.1/) | 5.4.17-2036 | November, 2020 |
| [UEK R6](https://docs.oracle.com/en/operating-systems/uek/6/relnotes6.0/) | 5.4.17-2011 | March, 2020 |


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-KernelBootParameters.html -->
...
| Option | Description |
| --- | --- |
| `0`, `1`, `2`, `3`, `4`, `5`, or `6`, or `systemd.unit=runlevelN.target` | Specifies the nearest `systemd`-equivalent system-state target to match a legacy SysV run level. N can take an integer value between 0 and 6. Systemd maps system-state targets to mimic the legacy SysV init system. For a description of system-state targets, see [Oracle Linux 8: Managing the System With systemd](https://docs.oracle.com/en/operating-systems/oracle-linux/8/systemd/). |
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-ParametersThatControlSystemPerformance.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-ParametersThatControlKernelPanics.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-AboutModuleParameters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-VirtualDirectoriesUnderthesysDirectoryVirtualDirectoriesUndersys.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/boot/boot-VirtualFilesandDirectoriesUnderprocUsefulVirtualFilesandDirectoriesUndertheprocDirectory.html -->
