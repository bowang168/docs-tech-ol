...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol8"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-Preface.html -->

[Oracle Linux 8: Setting Up High Availability
Clustering](https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/) describes how to install and configure
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/ref-copyright-ccbysa4.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/ref-conventions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/ref-doc-accessibility.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/ref-accessibility.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/ref-diversity.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-AboutHighAvailabilityClustering.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-InstallingandConfiguringPacemakerandCorosync.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-EnablingAccesstothePacemakerandCorosyncPackages.html -->

The Pacemaker and Corosync packages are available on the Oracle Linux yum server in the
`ol8_addons`
repository, or on the Unbreakable Linux Network (ULN) in the `ol8_arch_addons` channel.

Some dependency packages may be required from the
`ol8_appstream` and
`ol8_baseos_latest` yum repositories, or from
the
`ol8_arch_appstream`
and
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-InstallingandEnablingthePacemakerandCorosyncService.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-ConfiguringanInitialClusterandService.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-CreatingtheCluster.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-SettingClusterParameters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-CreatingaServiceandTestingFailover.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-ConfiguringPacemakerResourcesandResourceGroups.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-AboutPacemakerResourcesandResourceGroups.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-CreatingResources.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-ResourceStartandStopOrderinResourceGroup.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-CreatingaResourceGroup.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-ConfiguringFencingstonith.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-AboutFencingConfigurationstonith.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-FencingConfigurationExamples.html -->
...
If your high availability Oracle Linux cluster is hosted on Azure
virtual machines you need to use the Azure Resource Manager (ARM) fencing agent.

Note:

For systems hosted on Azure, clustering with Pacemaker and
Corosync is only available for Azure x86 VMs.

To set up and configure Azure ARM fencing:

1. On each node in the cluster, install the package with the Azure SDK
   dependency:

   ```
   sudo dnf install fence-agents-azure-arm python3-azure-sdk
   ```
2. On the node you have set up the `pcs`
   `cluster` on, run the following, once for each node in your
   cluster:
   ...
   pcmk_host_map="resolvable_host_name:Azure_VM_Name" \
   power_timeout=240 \
   ...
   - Replace resource\_stonith\_azure with a node-specific
     resource name of your choice.

     For example, you might specify resource name
     resource\_stonith\_azure-1 when you run the command
     for the first server, and resource\_stonith\_azure-2
     when you run the command for the second server, and so on.
   - Replace Azure\_resource\_group with the name of the
     resource group Azure portal resource group that holds VMs and other
     resources.
   - Replace Azure\_subscription\_id with your subscription
     ID in Azure.
   - Replace resolvable\_host\_name with the resolvable
     hostname of the node you are running the command for, and
     Azure\_VM\_Name with the name of the host in
     Azure.

     Note:

     The option `pcmk_host_map` is
     only required if the hostnames and the Azure VM names are not
     identical.
   - Replace fencegroup with a group name of your
     choice.

For more information about setting up fencing in an Oracle Linux cluster hosted on Azure
see the following:
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-ConfiguringFencingLevels.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-WorkingWithQuorumDevices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-InstallingandEnablingaQuorumDevice.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-ConfiguringtheClusterForaQuorumDevice.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-ManagingQuorumDevices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-UsingthePacemakerCorosyncWebUserInterface.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-AboutthePacemakerWebUserInterface.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-InitialClusterConfigurationTasks.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-ManagingClustersWiththeWebUI.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/availability/availability-MoreInformation.html -->
