...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol8"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-Preface.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-AboutPacketFilteringFirewalls.html -->
...
- Utilities to create, maintain, and display the rules that
  `netfilter` stores. In Oracle Linux 8, the default firewall utility is the
...
- The `nftables` framework is the default network
  ...
  includes packet classification facilities, added convenience, and improved performance.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-ConfiguringaPacketFilteringFirewall.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-FirewallConfigurationTools.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-ControllingtheFirewallService.html -->

## Controlling the firewalld Service

In Oracle Linux 8, the firewall service,
...
firewalld.service - firewalld - dynamic firewall daemon
 ...
 Main PID: 4261 (firewalld)
   ...
   CGroup: /system.slice/firewalld.service
           ââ4261 /usr/libexec/platform-python -s /usr/sbin/firewalld --nofork --nopid
```


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-AboutZonesandServices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-ConfiguringfirewalldZones.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-CreatingCustomizedZonesforFirewallImplementation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-UsingthenftablesFramework.html -->
...
This chapter also describes how to convert `iptables` and
`ip6tables` to the `nftables` framework.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-ControllingtheFirewallServiceNftables.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-CreatingtheFirewallServiceNftables.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-CreatingtheFirewallServiceNftableChainsRules.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-CreatingtheFirewallServiceNftableRules.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-PersistingtheFirewallServiceNftables.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-LoadingtheFirewallServiceNftables.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/firewall/firewall-Convertingiptablestonftables.html -->

## Converting iptables to nftables

If you query the system's `iptables` version, Oracle Linux 8 would clearly indicate that `nftables` is
