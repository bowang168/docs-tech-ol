...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/8/gprofng"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol8"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/gprofng/preface.html -->

## Preface

[Oracle Linux 8: Profiling For Performance Analysis
With Gprofng](https://docs.oracle.com/en/operating-systems/oracle-linux/8/gprofng/) describes how to install and use
the `gprofng` tool to find performance bottlenecks in executable programs.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/gprofng/about_gprofng_and_profiling.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/gprofng/installing_gprofng.html -->

## 2 Installing `gprofng`

Install the `binutils-gprofng` package on Oracle Linux 8.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/gprofng/getting_started_with_gprofng.html -->
...
Install the `binutils-gprofng` package. For more information, see [Installing gprofng](installing_gprofng.html#installing-gprofng "Install the binutils-gprofng package on Oracle Linux 8.").
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/gprofng/gprofng_command_reference.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/gprofng/working_with_gprofng_and_threaded_applications.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/gprofng/using_the_gprofng_gui.html -->
...
Before installing the `gprofng-gui` package, follow the steps in [Installing gprofng](installing_gprofng.html#installing-gprofng "Install the binutils-gprofng package on Oracle Linux 8.").
...
Install the `gprofng-gui` package. For more information, see [Installing gprofng-gui](using_the_gprofng_gui.html#installing-gprofng-gui "Install the gprofng-gui package on Oracle Linux 8.").
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/8/gprofng/known_issues.html -->
