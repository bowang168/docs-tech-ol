...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/9/pcp"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol9"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/pcp/pcp-Preface.html -->

## Preface

[Oracle Linux 9: Collecting and Analyzing Metrics With Performance Co-Pilot](https://docs.oracle.com/en/operating-systems/oracle-linux/9/pcp/) describes how to install and use Performance Co-Pilot
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/pcp/about_pcp.html -->
...
PCP also provides metrics and other performance-related information that were previously
provided by the Oracle OSWatcher Black Box (OSWbb) feature, as described in [Oracle Linux 8: Monitoring and Tuning the
System](https://docs.oracle.com/en/operating-systems/oracle-linux/8/monitoring/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/pcp/installing_and_starting_pcp.html -->

## 2 Installing and Starting PCP

Install the `pcp` package, and supplementary tools, on Oracle Linux 9.

Before installing the `pcp-oracle-conf` package, enable the
`ol9_addons` yum repository. For more information, see [Oracle Linux: Managing Software on Oracle
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/pcp/stopping_pcp.html -->
...
restarting disabled system services, see [Oracle Linux 9: Managing the System With
systemd](https://docs.oracle.com/en/operating-systems/oracle-linux/9/systemd/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/pcp/getting_started_with_pcp.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/pcp/pcp_command_reference.html -->
