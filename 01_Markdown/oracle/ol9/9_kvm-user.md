...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol9"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-Preface.html -->

## Preface

[Oracle Linux 9: KVM User's Guide](https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/) provides information about how to install, configure, and use the Oracle Linux KVM packages to run guest system on top of a bare metal Oracle Linux system. This documentation provides information on using KVM on a standalone platform in an unmanaged environment. Typical usage in this mode is for development and testing purposes, although production level deployments are supported. Oracle recommends that customers use Oracle Linux Virtualization Manager for more complex deployments of a managed KVM infrastructure.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-AboutOracleLinuxKVM.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-DescriptionoftheOracleLinuxKVMFeature.html -->
...
KVM stacks, see [Switch KVM Stacks](kvm-SwitchKVMStacks.html#kvm_SwitchKVMStacks "The following information describes how Oracle Linux 9 users can switch from the Default KVM stack to the Oracle KVM stack.The following information describes how Oracle Linux 9 users can switch from the Oracle KVM stack to the Default KVM stack.").
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-GuestOperatingSystemRequirements.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-SystemRequirementsandRecommendations.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-VirtualizationPackages.html -->
...
For installation instructions, see [KVM Host: Installation and Configuration](kvm-HostInstallationConfiguration.html "Install user-space packages, enable libvirt services, and validate that an Oracle Linux 9 system can host KVM virtual machines.").
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-VirtualizationPackageSources.html -->
...
| --- | --- | --- | --- |
| Default KVM Stack | - Fully supported across all Oracle Linux kernels. - Offers maximum compatibility with RHCK and Red Hat Enterprise Linux. | `ol9_appstream`  (Enabled by default on all Oracle Linux 9 systems) | The Default KVM stack can be installed without changing any repository configuration. |
| Oracle KVM Stack | - Offers newer KVM features and functionality available in upstream packages. - Engineered to work with KVM features that are enabled in the latest releases of UEK. - Requires the latest version of either UEK R7 or UEK 8. | `ol9_kvm_utils` | Before enabling this repository, you must remove all existing virtualization packages. |
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-HostInstallationConfiguration.html -->
...
1. **Optional:** If you require the Oracle KVM stack instead of the Default KVM stack, then
   [Enable Yum Repositories](kvm-EnableYumRepositories.html#kvm_EnableYumRepositories "To use any of the Oracle KVM stacks, first enable the ol9_kvm_utils yum repository before installing the virtualization packages.").
...
2. [Install Virtualization Packages](kvm-InstallVirtualizationPackages.html#kvm_InstallVirtualizationPackages "The following information describes how to install the virtualization packages on an Oracle Linux 9 system.").
...
4. **Optional:** On UEK systems only, [Switch KVM Stacks](kvm-SwitchKVMStacks.html#kvm_SwitchKVMStacks "The following information describes how Oracle Linux 9 users can switch from the Default KVM stack to the Oracle KVM stack.The following information describes how Oracle Linux 9 users can switch from the Oracle KVM stack to the Default KVM stack.") between the Default KVM stack and Oracle KVM stack.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-EnableYumRepositories.html -->

## Enable Yum Repositories

To use any of the Oracle KVM stacks, first enable the `ol9_kvm_utils` yum repository before
installing the virtualization packages.

Ensure that the following are true before proceeding:

- The system meets the virtualization package requirements . See [KVM Host: System Requirements](kvm-SystemRequirementsandRecommendations.html#kvm-requirements) and
  [Virtualization Package Sources](kvm-VirtualizationPackageSources.html#kvm_VirtualizationPackageSources_Copy).
- Either UEK R7  or UEK R8 is
...
in the standard yum repositories
...
1. Install or update the release package:
   ...
   ```
2. Enable the Oracle Linux 9 yum repository, by running the
...
After enabling the `ol9_kvm_utils` repository, you can install the Oracle KVM Stack. See [Install Virtualization Packages](kvm-InstallVirtualizationPackages.html#kvm_InstallVirtualizationPackages "The following information describes how to install the virtualization packages on an Oracle Linux 9 system.").


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-InstallVirtualizationPackages.html -->
...
- If installing the Oracle KVM stack:
  - The `ol9_kvm_utils` yum repository must be enabled. See [Enable Yum Repositories](kvm-EnableYumRepositories.html#kvm_EnableYumRepositories "To use any of the Oracle KVM stacks, first enable the ol9_kvm_utils yum repository before installing the virtualization packages.") for instructions.
...
3. Install the base virtualization packages and other utilities: 
   ...
   - To install the Oracle KVM stack, first remove any existing virtualization
     packages and then install the packages as usual:
...
5. Ensure that the `libvirt` daemons are running.
   ...
   Before you can create and manage KVM instances, the `libvirtd` daemons must be started and enabled. See [Manage the Libvirt Daemons](kvm-ManageLibvirtdDaemons.html "The following information describes how to start, enable, and check the status of the libvirt daemons on an Oracle Linux 9 KVM host.")
   for
   instructions.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-ValidatingtheHostSystem.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-SwitchKVMStacks.html -->
...
to be running on the host system and that the `ol9_kvm_utils` yum repository is
...
9 systems with UEK, see these topics:

- [Switch Default Stack to Oracle KVM Stack](kvm-SwitchKVMStacks.html#kvm_SwitchFromDefaultToOracleStack "The following information describes how Oracle Linux 9 users can switch from the Default KVM stack to the Oracle KVM stack.")
- [Switch Oracle KVM Stack to Default Stack](kvm-SwitchKVMStacks.html#kvm_SwitchFromOracleToDefaultStack "The following information describes how Oracle Linux 9 users can switch from the Oracle KVM stack to the Default KVM stack.")
...
9 users can switch from the Default KVM stack
to the Oracle KVM stack.

Ensure that the following are true before proceeding:

- The Oracle Linux
  9 system has the Default KVM stack
  packages installed.
- The host system must be running the latest UEK R7  or UEK R8.
- You have administrator privileges.
...
2. Enable the `ol9_kvm_utils` yum repository.
   ...
   See [Enable Yum Repositories](kvm-EnableYumRepositories.html#kvm_EnableYumRepositories "To use any of the Oracle KVM stacks, first enable the ol9_kvm_utils yum repository before installing the virtualization packages.").
...
The following information describes how Oracle Linux
9 users can switch from the Oracle KVM stack to
the Default KVM stack.

Ensure that the following are true before proceeding:

- The Oracle Linux
  9 system has the Oracle KVM stack packages installed.
- The host system is running the latest UEK R7  or UEK R8.
- You have administrator privileges.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-ManageLibvirtdDaemons.html -->
...
- Virtualization packages installed on the host system. See [Install Virtualization Packages](kvm-InstallVirtualizationPackages.html#kvm_InstallVirtualizationPackages "The following information describes how to install the virtualization packages on an Oracle Linux 9 system.") for
  details.
- An understanding of the `libvirt` driver daemons as of Oracle Linux
  9. For details, see [Types of libvirt Driver Daemons](kvm-TypesOfLibvirtDriverDaemons.html#concept_c4j_3dl_pcc)
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-TypesOfLibvirtDriverDaemons.html -->
...
- Modular libvirt - Oracle Linux
  ...
  Modular
  `libvirt`, which is newly introduced in Oracle Linux 9, provides a specific daemon for each hypervisor
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-KVMUsage.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-CreatingaNewVirtualMachine.html -->
...
- The KVM host has been prepared, as described in [KVM Host: Installation and Configuration](kvm-HostInstallationConfiguration.html "Install user-space packages, enable libvirt services, and validate that an Oracle Linux 9 system can host KVM virtual machines.").
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-CloningVirtualMachines.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-StartingandStoppingVirtualMachines.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-virsh-console.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-start-stop-remove.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-virsh-migrate-offline.html -->
...
- The `libvirt` daemons must be enabled on
  both hosts. See [Manage the Libvirt Daemons](kvm-ManageLibvirtdDaemons.html "The following information describes how to start, enable, and check the status of the libvirt daemons on an Oracle Linux 9 KVM host.")
  .
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-BaseOperations.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-config_vm_watchdog.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-ConfiguringaVirtualMachinewithaVirtualTrustedPlatformModule.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-network-topicgroup.html -->
...
To achieve high availability networking for any VMs, you must first configure a network bond on the host system. For details on how to set up network bonding, see Network Bonding in [Oracle Linux 9: Setting Up Networking](https://docs.oracle.com/en/operating-systems/oracle-linux/9/network/).
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-WorkingWithStorageforKVMGuests.html -->
...
- [Creating a Storage Volume from XML](kvm-WorkingWithStorageforKVMGuests.html#unique_892338517)
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-WorkingWithMemoryandCPUAllocation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-KnownIssuesforOracleLinuxKVM.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/kvm-KI_UsingvTPMWithGuestFailsIfFipsModeEnabled.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/38642712.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/38642712_2.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/kvm-user/39018293.html -->
