...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/9/install"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol9"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-Preface.html -->

## Preface

[Oracle Linux 9: Installing Oracle Linux](https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/) provides information about how to
install the Oracle Linux 9 release.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-PreparingToInstall.html -->
...
Linux release to the current major release version, use the Leapp utility. See [Oracle Linux 9: Upgrading Systems With Leapp](https://docs.oracle.com/en/operating-systems/oracle-linux/9/leapp/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-SystemRequirements.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-SystemConfiguration.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-DefaultDiskPartitionLayout.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-ObtainingInstallationImages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-PreparingInstallationMedia.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-CustomizingBootLoaderActions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-ConfiguringtheBootLoader.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-InstallationBootOptions.html -->
...
:   Specifies a web server as the location that contains everything needed to install the
    ...
    For example: `https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64`
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-InstallingOracleLinuxManually.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-InstallingOracleLinuxinGraphicsMode.html -->
...
- [User Settings](install-InstallingOracleLinuxinGraphicsMode.html#user-options "The Root Password window lets you set the root account password or lock the root account. This option lets you configure a user's credentials to enable access to the system. You can optionally configure the user to have administrative privileges. If the root account is disabled, you must configure the user as an administrator.")
...
You can skip configuring NTP until later by using the Chrony suite. See [Oracle Linux 9: Setting Up Networking](https://docs.oracle.com/en/operating-systems/oracle-linux/9/network/). See also [Configure Chrony on Oracle Linux](https://docs.oracle.com/en/learn/ol-chrony/).
...
Beginning with Oracle Linux 9, network connections are
automatically enabled. By default, network configuration uses DHCP for IPv4
...
For more information on SCAP policies and profiles, see [Oracle Linux 9: Using OpenSCAP for Security
Compliance](https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/).

### User Settings

Under User Settings, you configure the following options:

- [Root Password](install-InstallingOracleLinuxinGraphicsMode.html#root_password "The Root Password window lets you set the root account password or lock the root account.")
...
The Root Password window lets you set the root account password or lock
the root account.

Figure 3-12 Setting the root account
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-InstallinginTextMode.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-PostInstallationConfiguration.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-AutomatinganOracleLinuxInstallationbyUsingKickstart.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-AbouttheKickstartConfigurationFile.html -->
...
Beginning with Oracle Linux 9, the `root` account is locked by
default. To enable SSH root logins to the system, add the following line to the Kickstart
file.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-StartingtheKickstartInstallation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-InstallingUsingtheDriverUpdateDisk.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-InstallingaSystemWithaBtrfsrootFileSystem.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-UsingtheGUIInstaller.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-UsingtheTextInstaller.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-VerifyingtheBtrfsInstallation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-TroubleshootingOracleLinuxInstallations.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-TroubleshootingMenuOptions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-DebugandLogInformation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-CreatingaNetworkInstallationSetup.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-SettingUpanOracleLinuxNetworkInstallation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-ConfiguringPXEBootLoading.html -->
...
6. Create the `pxelinux.cfg/default` PXE configuration file.
   ...
   - `append` defines any parameters to append when loading the kernel,
     ...
     `https://yum.oracle.com/repo/OracleLinux/OL9/baseos/latest/x86_64` for
     ...
     subdirectory such as `pxelinux/OL9`, ensure you have the
...
6. Create the `/var/lib/tftpboot/efi/grub.cfg` boot loader
   ...
   such as `efi/OL9`, ensure you have the correct relative paths.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-SupportingDifferentKindsofClients.html -->
