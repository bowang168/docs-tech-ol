...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/9/security"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol9"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-Preface.html -->

## Preface

[Oracle Linux 9: Enhancing System Security](https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/) describes features in Oracle Linux 9 that can enhance the security of systems. The guide also
includes guidelines and recommendations for best security practices when working with Oracle
Linux.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-GuidelinesandBestPracticesforEnhancingSystemSecurity.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-MinimizeandSecuretheSoftwareFootprint.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-KeepSoftwareUptoDate.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-RestrictNetworkAccesstoCriticalServices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-ControlAuthenticationMechanismsandEnforcePasswordRestrictions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-FollowthePrincipleofLeastPrivilege.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-MonitorSystemActivity.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-KeepUptoDateontheLatestSecurityInformation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-PlanningforaSecureOracleLinuxEnvironment.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-RecommendedDeploymentConfigurations.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-ComponentSecurity.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-FeaturesandServicesforEnhancingSystemSecurity.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-AboutSystemSoftwareUpdates.html -->
...
Oracle Linux 9 provides tools to help you
...
- Cryptographic signature: All Oracle Linux RPM packages are signed and customers
  ...
  script migrates a system from Rocky Linux
  9 to Oracle
  Linux 9
...
Oracle Linux Premier Support includes the backporting of fixes for any Oracle Linux 9 package listed on the backport schedule and released by Oracle for up to six months from the release date of that package.

For example, the following table lists `glibc` packages available with their known release date and their expected end of life dates, with a hypothetical latest release provided on August 5, 2025:

| Package | Release Date | Backport End of Life |
| --- | --- | --- |
| `glibc-2.34-168.0.1.el9_6.14` | `23-May-2025` | November 23, 2025 |
| `glibc-2.34-168.0.1.el9_6.19` | `09-Jun-2025` | December 9, 2025 |
| `glibc-2.34-168.0.1.el9_6.20` | `30-Jun-2025` | December 30, 2025 |
| `glibc-2.34-168.0.1.el9_6.23` | `05-Aug-2025` | The latest release in this example. |
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-AboutCertificateManagement.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-AboutDataEncryption.html -->
...
- To protect against data theft, consider using full-disk encryption, especially on
  ...
  device is decrypted and its data is accessible. See [Oracle Linux 9: Managing Storage Devices](https://docs.oracle.com/en/operating-systems/oracle-linux/9/stordev/) for more information about encrypting block
...
- Oracle Linux uses encryption to store system passwords. By default, Oracle Linux 9 uses a strong password hashing algorithm (SHA-512) and stores hashed passwords in the `/etc/shadow` file.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-AboutthePacketFilteringFirewall.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-AboutSELinux.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-ImplementingAdditionalSecurityFeaturesandBestPractices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-DisablingCoreDumps.html -->

## Working with Core Dumps

Note:

The information in this chapter has been migrated to a separate and more updated documentation. See [Oracle Linux 9: Managing the System With
systemd](https://docs.oracle.com/en/operating-systems/oracle-linux/9/systemd/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-ConfiguringandUsingKernelSecurityMechanisms.html -->
...
Oracle Linux 9 binaries are typically built
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-RestrictingAccessToKernelRingBufferMessages.html -->
...
On Oracle Linux 9 systems running the Unbreakable Enterprise Kernel (UEK) 8, access is restricted by default.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-ConfiguringSystemCryptograpicPolicies.html -->

## Configuring System Cryptograpic Policies

Since Oracle Linux
8, Oracle Linux provides a facility to set a system-wide cryptographic policy. Many
...
FIPS
:   Configures the system to meet FIPS 140-3 requirements for cryptographic policies. This policy is enabled by the `fips-mode-setup` command used to enable FIPS mode on an Oracle Linux
    system. See [Configuring FIPS Mode in Oracle Linux 9](configuring_fips_mode.html#configuring-fips-mode) for more information on using this
    policy.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-CheckingUserAccountsandPrivileges.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-ConfiguringUserAuthenticationandPasswordPolicies.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-ConfiguringFileSystemMountsFilePermissionsandFileOwnerships.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-RestrictingAccesstoSSHConnections.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-UsingSystemAuditingandMonitoring.html -->

## Using System Auditing and Monitoring

Note:

The information in this chapter has been migrated to a separate and more updated documentation. See [Oracle Linux 9: Auditing the System With Auditd and Rsyslogd](https://docs.oracle.com/en/operating-systems/oracle-linux/9/auditing/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-UsingAdvancedIntrusionDetectionEnvironment.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-ImplementingSystemProcessAccounting.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-ProtectingtheRootDirectoryUsingchrootJails.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/fips_compliance.html -->

## 5 FIPS 140-3 Compliance in Oracle Linux 9
...
(FIPS) Publication 140-3.

FIPS Publication 140-3, Security Requirements for Cryptographic Modules, specifies the
...
Module Validation Program (CMVP) validates cryptographic modules to FIPS 140-3. Validated
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/configuring_fips_mode.html -->

## Configuring FIPS Mode in Oracle Linux 9

FIPS mode can be configured during the initial installation of Oracle Linux 9 or after
...
automatically configure a new Oracle Linux 9 system to run in FIPS mode from the first
boot.

The main benefit of setting FIPS mode during the installation stage is that Oracle Linux 9
enforces the use of strong cryptographic algorithms that are used to secure application data.

To verify that FIPS mode is enabled, run the following command after Oracle Linux 9 has been
installed:
...
You can configure a preexisting Oracle Linux 9 installation to run in FIPS mode by using the
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/fips_validated_modules.html -->

## FIPS 140-3 Validated Modules in Oracle Linux 9

The following sections describe how to review FIPS 140-3 certifications and install FIPS
140-3 validated cryptographic modules in Oracle Linux 9.
...
- Status of the FIPS 140-3 validation process.
  ...
  To achieve compliance with FIPS Publication 140-3, you must use the package version that the Security Policy
...
After you enable FIPS mode on Oracle Linux 9, you can then install FIPS validated
...
The following information applies to systems that are running a fully patched Oracle Linux 9
...
The Security Policy document explains how to verify that the package is FIPS 140-3 validated, and how to configure the
...
number, which includes a link to the NIST FIPS 140-3 validation page. This page provides details about FIPS certification and the
...
containing FIPS validated cryptographic modules for Oracle Linux 9:
...
Note that the
`ol9_u3_security_validation` yum
...
yum repository with identifier `ol9_MODRHCK` and
the corresponding ULN channel.

Security updates for the UEK7 cryptographic module are available in the
...
For specific instructions on installing FIPS validated cryptographic modules, see [Installing FIPS Validated Cryptographic Modules for Oracle Linux 9](fips_validated_modules.html#installing-fips-validated-crypto-modules).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-OracleLinuxCommonCriteriaCertification.html -->

## 6 Oracle Linux 9 Common Criteria Certification

Oracle Linux 9.3 was certified in February 2025 under the Canadian
Common Criteria Scheme and has proven Exact Conformance against the Protection Profile for
General Purpose Operating Systems (OSPP) 4.3.
...
Criteria Guide for the Oracle Linux 9 release that's installed.
For more information, see
[Common Criteria Guide for Oracle Linux 9.3](https://www.oracle.com/a/ocom/docs/oracle-linux-v9.3-common-criteria-guidance.pdf).
...
- [Protection Profile for General Purpose Operating
  Systems](http://www.commoncriteriaportal.org/nfs/ccpfiles/files/ppfiles/PP_OS_4.3.pdf)


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-SecurityConsiderationsforDevelopers.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-DesignPrinciplesforSecureCoding.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-GeneralGuidelinesforSecureCoding.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/security/security-GeneralGuidelinesforNetworkPrograms.html -->
