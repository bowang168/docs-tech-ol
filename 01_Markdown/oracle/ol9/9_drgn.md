...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol9"
...
Oracle Linux 9 Debugging the Kernel With Drgn and Corelens
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/drgn-Preface.html -->

## Preface

[Oracle Linux 9: Debugging the Kernel With Drgn and
Corelens](https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/) describes how to install and use the `drgn` and `corelens`
kernel debugging utilities to analyze crash logs and troubleshoot system problems.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/about_drgn_and_corelens.html -->
...
9 system to generate `vmcore` crash dumps, follow the kernel dump instructions in [Oracle Linux 9: Managing Kernels and System
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/installing_debuginfo_packages.html -->
...
Before installing `*-debuginfo` packages, enable the Oracle Linux 9
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/installing_drgn.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/installing_drgn_tools.html -->

## 4 Installing `drgn-tools`

Install the `drgn-tools` package on Oracle Linux 9.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/getting_started_with_drgn.html -->
...
Install the `drgn` package. For more information, see [Installing drgn](installing_drgn.html#installing-drgn "Install the drgn package on Oracle Linux 9.").
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/drgn_command_reference.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/using_the_drgn_library_with_python.html -->
...
installed on the system. For more information, see [Oracle Linux 9: Installing and Managing Python](https://docs.oracle.com/en/operating-systems/oracle-linux/9/python/).

If the script runs on Python 3.9,
also install the `drgn` package. For more information, see [Installing drgn](installing_drgn.html#installing-drgn "Install the drgn package on Oracle Linux 9.").

Note:

To import the `drgn` library in scripts that run on newer versions
of Python 3, enable the `ol9_addons` repository, then specify the version in the package name.
...
If no matching packages are available in the `ol9_addons` yum
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/getting_started_with_corelens.html -->
...
Install the `drgn-tools` package. For more information, see [Installing drgn-tools](installing_drgn_tools.html#installing-drgn-tools "Install the drgn-tools package on Oracle Linux 9.").
...
CTF is available if the system is running Oracle Linux 9 with the
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/drgn/corelens_command_reference.html -->
