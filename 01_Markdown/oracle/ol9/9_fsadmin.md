...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol9"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-Preface.html -->

## Preface

[Oracle Linux 9: Performing File System
Administration](https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/) provides information about
managing file systems and storage devices on Oracle Linux 9 systems.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/ref-copyright-ccbysa4.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/ref-conventions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/ref-doc-accessibility.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/ref-accessibility.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/ref-diversity.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-about_file_systems.html -->
...
:   A copy-on-write file system that's designed to address the expanding scalability
    ...
    See also [Oracle Linux 9: Managing the Btrfs File
...
:   A version of the extended file system. Ext4 includes the same features that are
    ...
    See also [Oracle Linux 9: Managing the Ext File System](https://docs.oracle.com/en/operating-systems/oracle-linux/9/ext/)
...
:   A high-performance, journaling file system that provides high scalability for I/O
    ...
    See also [Oracle Linux 9: Managing the XFS File System](https://docs.oracle.com/en/operating-systems/oracle-linux/9/xfs/)
...
:   NFS is a distributed file system protocol that lets systems share files over a network.
    ...
    [Oracle Linux 9: Managing the Network File System](https://docs.oracle.com/en/operating-systems/oracle-linux/9/nfs/)
...
:   The Oracle Cluster File System version 2 is a cluster file system designed for
    ...
    cluster. See
    [Oracle Linux 9: Managing the Oracle Cluster File System Version 2](https://docs.oracle.com/en/operating-systems/oracle-linux/9/ocfs2/)
    for more information.
...
:   CIFS (Common Internet File System) and SMB (Server Message Block) are network
    ...
    [Oracle Linux 9: Managing Samba](https://docs.oracle.com/en/operating-systems/oracle-linux/9/samba/)
    for more information.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-formatting_a_file_system_using_mkfs.html -->
...
- `mkfs.btrfs` - Format a file system using Btrfs. Requires UEK to be
  ...
  system is booted into UEK. See also [Oracle Linux 9: Managing the Btrfs File
  System](https://docs.oracle.com/en/operating-systems/oracle-linux/9/btrfs/)
- `mkfs.xfs` - Format a file system using XFS. See also
  [Oracle Linux 9: Managing the XFS File System](https://docs.oracle.com/en/operating-systems/oracle-linux/9/xfs/)
- `mkfs.ext4` - Format a file system using Ext4. See also
  [Oracle Linux 9: Managing the Ext File System](https://docs.oracle.com/en/operating-systems/oracle-linux/9/ext/)
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-managing_file_system_mounts.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-viewing_file_system_mount_information.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-common_mount_syntax_and_options.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-unmounting_a_filesystem.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-AbouttheFileSystemMountTable.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-ManagingSystemdMounts.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-managing_on_demand_mounts_using_autofs.html -->
...
such as NFS. For more information about NFS administration, see [Oracle Linux 9: Managing the Network File System](https://docs.oracle.com/en/operating-systems/oracle-linux/9/nfs/).
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-discarding_unused_blocks_on_a_file_system.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-using_fstrim_to_discard_unused_blocks.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-enabling_automatic_block_discard_using_the_fstrim_systemd_timer.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-configuring_access_control_lists.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-enabling_acls.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-setting_and_displaying_acls.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/fsadmin/fsadmin-using_disk_quotas.html -->
...
For information about how to configure quotas for an XFS file system, see [Oracle Linux 9: Managing the XFS File System](https://docs.oracle.com/en/operating-systems/oracle-linux/9/xfs/).

For information about how to configure quotas for an Ext file system, see [Oracle Linux 9: Managing the Ext File System](https://docs.oracle.com/en/operating-systems/oracle-linux/9/ext/).
...
available for a Btrfs file system as a technology preview in this release. See [Oracle Linux 9: Managing the Btrfs File
System](https://docs.oracle.com/en/operating-systems/oracle-linux/9/btrfs/).