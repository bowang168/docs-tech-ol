---
title: "Release Notes for Oracle Linux 9.7"
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol9"
...
Release Notes for Oracle Linux 9.7
...
Oracle Linux 9 Release Notes for Oracle Linux 9.7
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9.7-Preface.html -->

## Preface

[Oracle Linux 9: Release Notes for Oracle Linux 9.7](https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/) provides information about the new features and known issues in the Oracle
Linux 9.7 release. The information applies to both x86\_64 and 64-bit Arm (aarch64)
architectures. This document might be updated after first publication.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-AboutOracleLinux9.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9.0-SystemRequirementsandLimitations.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-AvailableArchitectures.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9.7-ShippedKernels.html -->
...
- `kernel-uek-6.12.0-105.51.5` (Unbreakable Enterprise Kernel 8 Update 1 (UEK 8U1)) (Default)
- `kernel-5.14.0-611.5.1` (Red Hat Compatible Kernel (RHCK))

For new installations, UEK 8 is automatically enabled and installed. It also becomes the
default kernel on first boot.

In the case of updates, switching to UEK R8 isn't automatic. If you're upgrading from any prior update release of Oracle Linux 9 that has UEK R7 as default, the system continues to run with the kernel that's already installed. See [UEK R8 Default Kernel Handling](ol9-features-Installation.html#ol9.7-features-UEKR8) for more information.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol-AbouttheUnbreakableEnterpriseKernel.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol-Compatibility.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-ObtainingInstallationImages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-UpgradingFromPreviousOracleLinuxReleases.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-UpgradingFromOracleLinuxUpdateReleases.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-NewFeaturesandChanges.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-features-Installation.html -->
...
UEK R8 Update 1 includes many new features including security and performance enhancements. For more details, see [Unbreakable Enterprise Kernel 8 Update 1: Release
Notes (6.12.0-100)](https://docs.oracle.com/en/operating-systems/uek/8/relnotes8.1/).

If you select RHCK as the default kernel instead of UEK, ensure that you disable UEK yum repositories or ULN channels. For more information about switching to RHCK, see [Oracle Linux 9: Managing Kernels and System
...
- Updating by using yum
  ...
  When you update to Oracle Linux 9.7, the previous kernel is preserved. At the same time,
  the UEK R8 yum repository is also added to the system yum configuration. To move to the
  latest kernel, run the following commands:
...
After setting the default kernel, you can further configure kernel boot parameters so that these parameters are applied at every system boot. For instructions, see [Oracle Linux 9: Managing Kernels and System
Boot](https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-features-OSandSoftwareMgmt.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-features-Security.html -->
...
Oracle Linux 9.7 introduces a PQ subpolicy in `crypto-policies` that enables
post-quantum cryptography. Notable changes include:
...
With Oracle Linux 9.7, OpenSSL is updated to version 3.5. You can now improve security for TLS connections and cryptographic operations in Oracle Linux
...
With Oracle Linux 9.7, use the `SSLKEYLOGFILE` environment variable to
instruct OpenSSL to log TLS connection secrets to a file.
...
Oracle Linux 9.7 adds FIPS mode support for hybrid Module-Lattice-Based Key Encapsulation
Mechanism (ML-KEM), so OpenSSL uses both classical and post-quantum algorithms for key
exchanges.

### `crypto-policies` Support Ed25519 in NSS

`crypto-policies` in Oracle Linux 9.7 now enable Ed25519 in DEFAULT, LEGACY,
and FUTURE policies for NSS, so you can use this efficient elliptic curve algorithm.

### `rpm-sequoia` Package for Quantum-Resistant RPM Signatures

With Oracle Linux 9.7, you can use the `rpm-sequoia` package to verify RPM packages with post-quantum cryptographic algorithms such as ML-DSA
for enhanced security.

RPM signatures with PQ certificates can be verified using extra `pqrpm` package. You can use the DNF `multisig` plugin once the
you have run the `pqrpm rpmkeys` setup utility. Only RPMs signed with a regular signature and the additional PQ signature pass validation.
...
- Updated `accounts_passwords_pam_faillock` related rules to support only newer Oracle Linux versions that use `/etc/security/faillock.conf` configuration file.
- Added a rule to check `/etc/security/pwquality.conf` or files inside `/etc/pam.d/` depending on the Oracle Linux version.

### SELinux Assigns `diagnostic_device_t type` to `/dev/diag`

Oracle Linux 9.7 now includes the `diagnostic_device_t type` for
`/dev/diag` in the SELinux policy. This type lets you control access to
the device for diagnostics.

This change increases security by restricting `/dev/diag` to appropriate
SELinux contexts in Oracle Linux systems.

### SELinux Policy Adds Rules for `qgs` Daemon

Oracle Linux 9.7 introduces a new `qgs_t type` and access rules for the
`qgs` daemon in the SELinux policy, which lets the daemon operate securely in
...
In Oracle Linux 9.7, the SELinux domains for `powerprofiles_t`,
`samba_bgqd_t`, and `switcheroo_control_t` now run in
enforcing mode and no longer operate in permissive mode.
...
The `tuned-ppd` SELinux policy is updated to confine the
`tuned-ppd` service. The service previously ran with the
`unconfined_service_t` SELinux label. With this update, the service is no
longer unconfined and runs successfully in SELinux enforcing mode.

### `fips-provider-next` Package Added

The `fips-provider-next` package is offered as a technology preview of the
next version of the FIPS provider. This package might be submitted to the National Institute
of Standards and Technology (NIST) for future validation. The
`openssl-fips-provider` remains the validated FIPS provider.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-features-FileSystemsandStorage.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-features-HighAvailabilityandClusters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-features-DynamicProgramming.html -->
...
### Valkey 8 now Available in Oracle Linux

Oracle Linux 9.7 includes Valkey 8, a high-performance key-value store compatible with Redis
clients, supporting strings, hashes, lists, sets, and sorted sets. You can store strings,
hashes, lists, sets, and sorted sets efficiently using its in-memory engine with options for
disk persistence.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-features-CompilersandDevTools.html -->
...
Oracle Linux 9.7 splits `valgrind` into subpackages for core, scripts, GDB
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-features-Containers.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-features-Cockpit.html -->
...
Oracle Linux 9.7 updates the `cockpit` packages to version 344. Notable
updates include:

- A redesigned user interface based on PatternFly 6
- SMART technology support and Stratis 3.8+ pool format in Storage
- Improved graphical VNC, control VNC, and serial consoles in Virtual Machines
- IPv6 support for WireGuard VPNs in Networking
- Easy branding of web console pages using the `branding.css` file

### cockpit-ws-selinux Subpackage Added

Oracle Linux 9.7 now provides the SELinux policy for `cockpit_ws` processes in
a separate `cockpit-ws-selinux` subpackage to prevent failures in the web
console on systems where SELinux isn't installed. The change helps to avoid unnecessary
package dependencies. See `cockpit_ws_selinux(8)` for details.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-TechnologyPreview.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-techprev-Security.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-techprev-InfrastructureServices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-techprev-Networking.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-techprev-Kernel.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-techprev-FileSysandStorage.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-techprev-CompilersandDevTools.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-techprev-Virtualization.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-DeprecatedFeatures.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-Installation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-SoftwareManagement.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-ShellandCommandLine.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-Security.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-Networking.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-Kernel.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-FileSystemsandStorage.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-HA.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-DynamicProgramming.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-CompilersandDev.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-IdentityManagementandAuthentication.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-Virtualization.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-deprecated-Containers.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9.5-deprecated-packages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-KnownIssues.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-InstallationIssues.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-VirtualizationIssues.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol9-KernelIssues.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/issue-35270637_35034465.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/issue-34050377.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/issue-36028061.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/issue-36512929.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/issue-37290712.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol-PackageChangesfromtheUpstreamRelease.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol-ChangestoBinaryPackages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/relnotes9.7/ol-ChangestoSourcePackages.html -->
