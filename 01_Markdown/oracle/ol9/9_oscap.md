...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol9"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/oscap-Preface.html -->

## Preface

[Oracle Linux 9: Using OpenSCAP for Security
Compliance](https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/) describes how
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/oscap-WhatIsSCAP.html -->
...
The Oracle Linux installer also provides options to install the OS to match a specific security profile or policy as defined by the XCCDF profiles available in the `scap-security-guide` package. By applying a policy during installation, you can ensure the system is compliant when it begins operation. See [Oracle Linux 9: Installing Oracle Linux](https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/) for more information.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/oscap-SCAPPackages.html -->
...
For information about SCAP package features and other changes in Oracle Linux 9, see the release notes in the [Oracle Linux 9 documentation](https://docs.oracle.com/en/operating-systems/oracle-linux/9/).
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/oscap_information_and_reference.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/oscap-CheckingComplianceWithOSCAP.html -->
...
WARNING: Skipping 'https://linux.oracle.com/security/oval/com.oracle.elsa-ol9.xml.bz2' file which is referenced 
      from datastream
		...
		Profiles:
			...
			Title: Centro CriptolÃ³gico Nacional (CCN) - STIC for Oracle Linux 9 - Advanced
				Id: xccdf_org.ssgproject.content_profile_ccn_advanced
			Title: Centro CriptolÃ³gico Nacional (CCN) - STIC for Oracle Linux 9 - Basic
				Id: xccdf_org.ssgproject.content_profile_ccn_basic
			Title: Centro CriptolÃ³gico Nacional (CCN) - STIC for Oracle Linux 9 - Intermediate
...
2. Run a scan using that profile.
   ...
   The `--fetch-remote-resources` option lets OSCAP connect to the internet to download remote resources that are required for the XCCDF profile evaluation. Or, you can use the `--local-files` option for OSCAP to access those resources at the specified path. The `ssg-ol9-ds.xml` data stream file includes a reference to the remotely hosted OVAL definitions that can verify whether a system is patched appropriately.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/xccdf_remediation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/auditing_for_vulnerabilities_by_using_oval_definitions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/oscap-ScanContainerImagesandContainers.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/oscap-ScanOfflineFileSystems.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/oscap/scanning_remote_systems.html -->
...
Although it might be possible to connect as the root user on a remote system directly over SSH, we recommend not doing this. Always use `oscap-ssh` with the `--sudo` option and configure an appropriate user on the remote system for this task. See [Oracle Linux 9: Setting Up System Users and
Authentication](https://docs.oracle.com/en/operating-systems/oracle-linux/9/userauth/) for more information.