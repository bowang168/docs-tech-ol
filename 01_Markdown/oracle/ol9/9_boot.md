...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol9"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-Preface.html -->

## Preface

[Oracle Linux 9: Managing Kernels and System
Boot](https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/)
provides information about configuring the Oracle Linux 9 boot loader,
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-AbouttheBootProcess.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-AboutUEFIBasedBooting.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-AboutBIOSBasedBooting.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-AbouttheGRUB2Bootloader.html -->
...
name `machine_id-kernel_version.el9.arch.conf`.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-about_linux_kernels.html -->
...
[Oracle Linux 9 Kernel Reference](oracle_linux9_kernel_version_matrix.html "The information provided in this reference can help you to understand the different kernel versions that are available for Oracle Linux 9.")
.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-AboutKernelModules.html -->
...
```
ls -l /lib/modules/5.15.0-208.159.3.2.el9.x86_64/weak-updates/kmod-kvdo/uds
```

```
lrwxrwxrwx. 1 root root 68 Jul  8 07:57 uds.ko -> 
/lib/modules/5.15.0-208.159.3.2.el9.x86_64/extra/kmod-kvdo/uds/uds.ko
```

```
ls -l /lib/modules/5.15.0-208.159.3.2.el9.x86_64/weak-updates/kmod-kvdo/vdo
```
...
For more information about external driver modules and driver update disks, see [Oracle Linux 9: Installing Oracle Linux](https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-ConfiguringSystemSettings.html -->
...
:   Defines a list of btrfs file systems and thinly provisioned
    ...
    For more information, see [Oracle Linux 9: Performing File System
...
[Oracle Linux 9: Managing System Devices With
udev](https://docs.oracle.com/en/operating-systems/oracle-linux/9/udev/)
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-ChangingKernelBootParametersBeforeBooting.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-UsinggrubbyToManageKernels.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-UsinggrubbyToManageKernels_check_available_kernels.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-UsinggrubbyToManageKernels_check_the_current_default_kernel.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-UsinggrubbyToManageKernels_change_the_default_kernel.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-UsinggrubbyToManageKernels_change_kernel_command_line_boot_parameters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-UsinggrubbyToManageKernels_check_last_kernel_cmdline.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-ModifyingKernelParameters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-list_all_configurable_kernel_parameters_and_values.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-updating_kernel_parameters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-ManagingKernelModules.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-ListingInformationAboutLoadedModules.html -->
...
- Use the `modinfo -n` command to find the file path to the module on
  ...
  ```
  /lib/modules/5.15.0-208.159.3.2.el9uek.x86_64/kernel/drivers/parport/parport.ko.xz
  ```


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-LoadingandUnloadingModules.html -->
...
- Load a kernel module using the `modprobe` command.
  ...
  ```
  insmod /lib/modules/5.15.0-208.159.3.2.el9uek.x86_64/kernel/net/sunrpc/auth_gss/auth_rpcgss.ko 
  insmod /lib/modules/5.15.0-208.159.3.2.el9uek.x86_64/kernel/fs/nfs_common/nfs_acl.ko 
  insmod /lib/modules/5.15.0-208.159.3.2.el9uek.x86_64/kernel/fs/fscache/fscache.ko 
  ...
  ```
...
- Unload a module by using the `modprobe -r` command.
  ...
  ```
  rmmod /lib/modules/5.15.0-208.159.3.2.el9uek.x86_64/kernel/fs/nfs/nfs.ko
  rmmod /lib/modules/5.15.0-208.159.3.2.el9uek.x86_64/kernel/fs/lockd/lockd.ko
  rmmod /lib/modules/5.15.0-208.159.3.2.el9uek.x86_64/kernel/fs/fscache/fscache.ko
  ...
  ```
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-ChangingKernelModuleOptions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-SpecifyingModulesToBeLoadedatBootTime.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-PreventingModulesFromLoadingatBootTime.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-RemovingWeakModules.html -->
...
1. Remove the symbolic link manually.
   ...
   ```
   sudo rm -rf /lib/modules/5.15.0-208.159.3.2.el9uek.x86_64/weak-updates/kmod-kvdo
   ```

   In this example, the weak update module, kmod-kvdo, is removed from
   the kernel, 5.15.0-208.159.3.2.el9uek.x86\_64.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-Managing_Resources_Cgroups.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/cgroups-EnableCGrp2.html -->

## Verifying cgroups v2

At boot time, Oracle Linux 9 mounts `cgroups v2` by
default.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/cgroups-ResourceControllers.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/cgroups-CGroupFileSystem.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/cgroups-ResourceDistModels.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/cgroups-CgroupsV2AppResMgt.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-ConfigWatchdogServ.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/monitoring-WorkingWithKernelDumps.html -->
...
Kdump in [Oracle Linux 9: Managing Shared File Systems](https://docs.oracle.com/en/operating-systems/oracle-linux/9/shareadmin/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/kdump_system_requirements.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/kdump-memory_reservation.html -->
...
You can automatically update `grub.conf` with the recommended
`crashkernel` reservation size by running the following command:
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/monitoring-InstallingKdump.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/monitoring-ConfiguringKdump.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/monitoring-AnalyzingKdumpOutput.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/monitoring-UsingEarlyKdump.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/oracle_linux9_kernel_version_matrix.html -->

## 10 Oracle Linux 9 Kernel Reference

The information provided in this reference can help you to understand the different
kernel versions that are available for Oracle Linux 9.

Oracle Linux 9 Kernel Version Matrix

The following tables provide an overview of kernel availability on Oracle Linux 9
...
Oracle Linux 9 releases on aarch64 platforms only include
UEK kernel packages. RHCK isn't provided for this platform architecture.

Table 10-1 Kernel Availability on Oracle Linux 9 Releases for x86\_64

| Oracle Linux 9 Update Level | Initial UEK Version | Initial RHCK Version | UEK R7 | UEK 8 |
| --- | --- | --- | --- | --- |
| 9.7 | kernel-uek-6.12.0-105.51.5 | kernel-5.14.0-611.5.1 | Yes | Yes, default |
| 9.6 | kernel-uek-6.12.0-1.23.3.2 | kernel-5.14.0-570.12.1 | Yes | Yes, default |
| 9.5 | kernel-uek-5.15.0-302.167.6 | kernel-5.14.0-503.11.1 | Yes, default | No |
| 9.4 | kernel-uek-5.15.0-205.149.5.1 | kernel-5.14.0-427 | Yes, default | No |
| 9.3 | kernel-uek-5.15.0-200.131.27 | kernel-5.14.0-362.8.1 | Yes, default | No |
| 9.2 | kernel-uek-5.15.0-101.103.2.1 | kernel-5.14.0-284.11.1 | Yes, default | No |
| 9.1 | kernel-uek-5.15.0-3.60.5.1 | kernel-5.14.0-162.6.1 | Yes, default | No |
| 9.0 | kernel-uek-5.15.0-0.30.19 | kernel-5.14.0-70.13.1.0.3 | Yes, default | No |

Table 10-2 Kernel Availability on Oracle Linux 9 Releases for aarch64

| Oracle Linux 9 Update Level | Initial UEK Version |
| --- | --- |
| 9.7 | kernel-uek-6.12.0-105.51.5 |
| 9.6 | kernel-uek-6.12.0-0.20.20 |
| 9.5 | kernel-uek-5.15.0-302.167.6 |
| 9.4 | kernel-uek-5.15.0-205.149.5.1 |
| 9.3 | kernel-uek-5.15.0-200.131.27 |
| 9.2 | kernel-uek-5.15.0-101.103.2.1 |
| 9.1 | kernel-uek-5.15.0-3.60.5.1 |
| 9.0 | kernel-uek-5.15.0-0.30 |
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-KernelBootParameters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-ParametersThatControlSystemPerformance.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-ParametersThatControlKernelPanics.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-AboutModuleParameters.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-VirtualDirectoriesUnderthesysDirectoryVirtualDirectoriesUndersys.html -->
...
| `devices` | Contains the global device hierarchy of all devices on the system. The platform directory contains peripheral devices such as device controllers that are specific to a particular platform. The `system` directory contains non peripheral devices such as CPUs and APICs. The `virtual` directory contains virtual and pseudo devices. See [Oracle Linux 9: Managing System Devices With udev](https://docs.oracle.com/en/operating-systems/oracle-linux/9/udev/) for more information about device management. |
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/9/boot/boot-VirtualFilesandDirectoriesUnderprocUsefulVirtualFilesandDirectoriesUndertheprocDirectory.html -->
