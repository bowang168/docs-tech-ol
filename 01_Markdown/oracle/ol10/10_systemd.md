...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol10"
...
Oracle Linux 10 Managing the System With systemd
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/preface.html -->

## Preface

[Oracle Linux 10: System Management with
systemd](https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/) describes how to use systemd to manage
core system configuration, services, timer units, and resource usage.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/systemd.html -->
...
For more information about system boot, see [Oracle Linux 10: Managing Kernels and System
Boot](https://docs.oracle.com/en/operating-systems/oracle-linux/10/boot/)


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/AboutthesystemdServiceManager.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/SystemdUnits.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/systemdUtilities.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/SystemCommands.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/RunningsystemctlonaRemoteSystem.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ConfiguringSystemDateandTimeSettings.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ConfigLocale.html -->
...
see [Oracle Linux 10: Installing Oracle Linux](https://docs.oracle.com/en/operating-systems/oracle-linux/10/install/).
...
1. To list all language packs already installed on the system and all language packs available on the `ol10_appstream` repository, type: 

   ```
   sudo dnf list langpacks-*
   ```

   For example, the following shows that this system has Spanish, French, Japanese, and Russian language packs installed followed by a truncated list of language packs available on `ol10_appstream`.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/AboutSystemStateTargets.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/DisplayingDefaultandActiveSystemStateTargets.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ChangingDefaultandActiveSystemStateTargets.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ServiceManagement.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/StartingandStoppingServices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/EnablingandDisablingServices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/DisplayingtheStatusofServices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ControllingAccesstoSystemResources.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/CreatingasystemdUserBasedService.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ModifyingsystemdConfigurationFiles.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/WorkingWithTimers.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/UsingTimerUnits.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ConfiguringRealtimeTimerUnit.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ConfiguringMonotonicTimerUnit.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/RunningTransientTimerUnit.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/SystemLoggingWithJournalctl.html -->

## 6 System Logging

systemd has its own logging system called the journal. The journal is handled by the
`systemd-journald` service unit. Although it's possible to run another
...
describe the subsystems and services that generate messages as defined in [RFC 5424](https://tools.ietf.org/html/rfc5424#section-6.2.1). See the
`systemd-journald.service(8)` manual page for more information.

Journal configuration is controlled by editing the
`/etc/systemd/journald.conf` file. The preferred approach to updating
journal configuration is to use systemd drop-in configuration to make changes. See [Adding Persistent Journal Storage](adding_persistent_journal_storage.html#task_jn5_jg2_b2c "Add persistent journal storage if you want log entries to persist across reboots, for greater historical reference and for deeper auditing purposes.") for an
example of creating a drop-in configuration file. Also see the
`journald.conf(5)` manual page for more information about
configuration options.

Use `journalctl` to view and manage system logs.
`journalctl` is a utility used to query and display log messages
from the systemd journal. See [Viewing and Filtering Log Messages](SystemLoggingWithJournalctl_filtering_log_messages.html#systemloggingwithjournalctl_filtering_log_messages "To view and filter log messages in the journal, you can use the journalctl command.") for more information. You can also use `journalctl`
to manage certain journal runtime behavior. For example, you can use the
`--disk-usage` option to view how much disk space the journal is
using. You can also use the `--rotate` option to force log rotation, and
the `--vacuum-size` or -`-vacuum-time` to limit how much
data is stored in the rotated journal files. See the `journalctl(1)`
manual page for more information.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/SystemLoggingWithJournalctl_filtering_log_messages.html -->

## Viewing and Filtering Log Messages

To view and filter log messages in the journal, you can use the
`journalctl` command.
...
When run without any options, the `journalctl` command displays all log
messages.

You can also run the `journalctl --grep` command to return only lines
that match a specified string or regular expression. If the string specified is all in
lowercase, the match is treated as case-insensitive. If you need a case-sensitive match
on a lowercase string, you can override this behavior with the
`--case-sensitive` option.

You can apply other filters to log messages to limit output by specifying various
filtering options, including:

- `-S`, `--since`: Show only lines in the log after a
  specified date, time, or duration. For example, you can run any of the following
  commands:
  ...
  ```
- `-U`, `--until`: Show only lines in the log before a
  specified date, time, or duration. For example, you can
  run:

  ```
  journalctl --until "10 minutes ago"
  ```
- `-f`, `--follow`: Follow the journal as it's being
  updated and display new entries as they're added. Use the `Ctrl-c`
  keyboard sequence to exit the log.
- `-n`, `--lines`: Show only the most recent n
  lines.
- `-b`, `--boot`: Show only the lines from the specified
  boot. If set to `0`, log lines from the most recent boot are shown.
  If set to `-1`, log lines from the previous boot are used. Note that
  you need persistent storage for journald enabled to retain logs from previous boots.
  See [Adding Persistent Journal Storage](adding_persistent_journal_storage.html#task_jn5_jg2_b2c "Add persistent journal storage if you want log entries to persist across reboots, for greater historical reference and for deeper auditing purposes.").
- `-u`, `--unit`: Filter by unit name. For example,
  you can run:
- ```
  journalctl -u cockpit.socket
  journalctl -u cockpit.service
  ```
- `-t`, `--identifier`: Filter by syslog identifier.
  For example, you can
  run:
  ...
  journalctl -t sudo
  ```
- `-p`, `--priority`: Filter by syslog priority. For
  example you can run:
- ```
  journalctl -p crit
  ```
- `-x`, `--catalog`: Include extra explanation texts
  from the message catalog, if available. These explanations can make log output
  dense, but can also be helpful in finding resolutions for issues that might appear
  in the log.

You can combine any of the filtering options to narrow the returned log information to
exactly what you need. For example, to see all systemd's log activity for the current
date until and hour ago, and to include explanatory messages, run:
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/adding_persistent_journal_storage.html -->

## Adding Persistent Journal Storage

Add persistent journal storage if you want log entries to persist across reboots, for
greater historical reference and for deeper auditing purposes.

By default, the systemd journal is stored in volatile storage under
`/run/log/journal`. This storage is wiped at reboot. To
create persistent journal storage, that's preserved after reboot, you can create the
appropriate directory structure, set the correct permissions and edit the journald
configuration.

1. Create the persistent storage directory in
   `/var/log/journal`.

   ```
   sudo mkdir /var/log/journal
   ```
2. Set the appropriate permissions and configure the directory for
   systemd-journald access.

   ```
   sudo systemd-tmpfiles --create --prefix /var/log/journal
   ```
3. Optionally, create a systemd journald drop-in configuration file in
   `/etc/systemd/journald.conf.d/` and set the Storage
   parameter to persistent.

   Creating a systemd journald drop-in configuration can help make it clearer
   that the configuration is set to use persistent storage. This step is
   optional because, by default, the storage is set to 'auto' and journald
   switches to persistent if the /var/log/journal directory exists.
   ...
   EOF
   ```
4. Restart the systemd-journald service and flush the journal to force it to
   switch from volatile to persistent storage.
...
5. Validate that the journal has switched to persistent storage.
   ...
   You can check the `/var/log/journal` directory to ensure
   that it's populated with data.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/CoreDumps.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/EnablingCoreDumps.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ConfiguringCoreDumps.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/AnalyzingCoreDumps.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ExportingCoreDumps.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/ControlGroups.html -->
...
Oracle Linux uses the control groups version 2 (`cgroups
v2)` implementation. These groups provide a single control group hierarchy against
which all resource controllers are mounted. In this hierarchy, you can obtain better proper
...
Note that `cgroups v1` is deprecated and is not available on Oracle Linux 10. The `cgroups v2` functionality is enabled
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/CgroupsandSystemd.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/SystemdMngCgroupsV2.html -->
