...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/10/security"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol10"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-Preface.html -->

## Preface

[Oracle Linux 10: Enhancing System Security](https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/) describes features in Oracle Linux 10 that can enhance the security of systems. The guide also
includes guidelines and recommendations for best security practices when working with Oracle
Linux.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-GuidelinesandBestPracticesforEnhancingSystemSecurity.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-MinimizeandSecuretheSoftwareFootprint.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-KeepSoftwareUptoDate.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-RestrictNetworkAccesstoCriticalServices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-ControlAuthenticationMechanismsandEnforcePasswordRestrictions.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-FollowthePrincipleofLeastPrivilege.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-MonitorSystemActivity.html -->
...
See [Oracle Linux 10: Auditing the System With Auditd and Rsyslogd](https://docs.oracle.com/en/operating-systems/oracle-linux/10/auditing/) and [Using Advanced Intrusion Detection Environment](security-UsingAdvancedIntrusionDetectionEnvironment.html#harden-aide) for more information.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-KeepUptoDateontheLatestSecurityInformation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-PlanningforaSecureOracleLinuxEnvironment.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-RecommendedDeploymentConfigurations.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-ComponentSecurity.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-FeaturesandServicesforEnhancingSystemSecurity.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-AboutSystemSoftwareUpdates.html -->
...
Oracle Linux 10 provides tools to help you
...
Linux mailing list at <https://oss.oracle.com/mailman/listinfo/el-errata>.
...
Oracle Linux Premier Support includes the backporting of fixes for any Oracle Linux 10 package listed on the backport schedule and released by Oracle for up to six months from the release date of that package.

For example, the following table lists `glibc` packages available with their known release date and their expected end of life dates, with a hypothetical latest release provided on August 8, 2025:

| Package | Release Date | Backport End of Life |
| --- | --- | --- |
| `glibc-2.39-37.0.1.el10` | `26-Jun-2025` | December 26, 2025 |
| `glibc-2.39-43.0.1.el10_0` | `16-Jul-2025` | January 16, 2026 |
| `glibc-2.39-46.0.1.el10_0` | `08-Aug-2025` | The latest release in this example. |
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-AboutCertificateManagement.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-AboutDataEncryption.html -->
...
- To protect against data theft, consider using full-disk encryption, especially on
  ...
  device is decrypted and its data is accessible. See [Oracle Linux 10: Managing Storage
  Devices](https://docs.oracle.com/en/operating-systems/oracle-linux/10/stordev/) for more information about encrypting block
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-AboutthePacketFilteringFirewall.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-AboutSELinux.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-ImplementingAdditionalSecurityFeaturesandBestPractices.html -->
...
For more information about securely monitoring, auditing, and logging an Oracle Linux 10 system, see [Oracle Linux 10: Auditing the System With Auditd and Rsyslogd](https://docs.oracle.com/en/operating-systems/oracle-linux/10/auditing/) and [Oracle Linux 10: System Management with
systemd](https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-ConfiguringandUsingKernelSecurityMechanisms.html -->
...
Oracle Linux 10 binaries are typically built
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-RestrictingAccessToKernelRingBufferMessages.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-ConfiguringSystemCryptograpicPolicies.html -->
...
FIPS
:   Configures the system to meet FIPS 140-3 requirements for cryptographic policies. This policy is enabled when Oracle Linux 10 is installed with FIPS mode enabled. See [Configuring FIPS Mode in Oracle Linux 10](configuring_fips_mode.html#configuring-fips-mode) for more information on using this
    policy.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-CheckingUserAccountsandPrivileges.html -->
...
password (`P`). The third field shows the date on which the user last changed
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-ConfiguringUserAuthenticationandPasswordPolicies.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-ConfiguringFileSystemMountsFilePermissionsandFileOwnerships.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-RestrictingAccesstoSSHConnections.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-UsingAdvancedIntrusionDetectionEnvironment.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-ProtectingtheRootDirectoryUsingchrootJails.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/fips_compliance.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/configuring_fips_mode.html -->
...
automatically configure a new Oracle Linux 10 system to run in FIPS mode from the first
boot.

The main benefit of setting FIPS mode during the installation stage is that Oracle Linux 10
enforces the use of strong cryptographic algorithms that are used to secure application data.

To verify that FIPS mode is enabled, run the following command after Oracle Linux 10 has been
installed:
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/fips_validated_modules.html -->

## FIPS 140-3 Validated Modules in Oracle Linux 10

The following sections describe how to review FIPS certifications and install FIPS
140-3 validated cryptographic modules in Oracle Linux 10.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-SecurityConsiderationsforDevelopers.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-DesignPrinciplesforSecureCoding.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-GeneralGuidelinesforSecureCoding.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/security/security-GeneralGuidelinesforNetworkPrograms.html -->
