...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol10"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-Preface.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-AboutPacketFilteringFirewalls.html -->
...
- Utilities to create, maintain, and display the rules that
  `netfilter` stores. In Oracle Linux 10, the default firewall utility is the
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-ConfiguringaPacketFilteringFirewall.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-FirewallConfigurationTools.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-ControllingtheFirewallService.html -->

## Controlling the firewalld Service

In Oracle Linux 10, the firewall service,
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-AboutZonesandServices.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-ConfiguringfirewalldZones.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-CreatingCustomizedZonesforFirewallImplementation.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-UsingthenftablesFramework.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-ControllingtheFirewallServiceNftables.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-CreatingtheFirewallServiceNftables.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-CreatingtheFirewallServiceNftableChainsRules.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-CreatingtheFirewallServiceNftableRules.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-PersistingtheFirewallServiceNftables.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/firewall/firewall-LoadingtheFirewallServiceNftables.html -->
