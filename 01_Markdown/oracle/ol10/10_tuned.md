...
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol10"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/tuned-Preface.html -->

## Preface

[Oracle Linux 10: Optimize Performance and Power Consumption With TuneD and PowerTOP](https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/) describes how to install and use the TuneD and PowerTOP tools to monitor performance and
reduce power consumption.


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/about_tuned.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/installing_tuned.html -->

## 2 Installing TuneD

Install the `tuned` package on Oracle Linux 10.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/reviewing_tuned_global_settings.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/reviewing_tuned_profiles.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/tuned_command_reference.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/creating_custom_tuned_profile.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/about_powertop.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/installing_powertop.html -->

## 8 Installing PowerTOP

Install the `powertop` package on Oracle Linux 10 so that you can use the
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/powertop_command_reference.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/installing_powertop2tuned.html -->

## 10 Installing powertop2tuned

Install `powertop2tuned` on Oracle Linux 10.
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/tuned/using_powertop2tuned_to_create_a_tuned_profile.html -->
