---
title: "Monitor Performance with Performance Co-Pilot"
source_url: "https://docs.oracle.com/en/operating-systems/oracle-linux/10/pcp"
fetched: 2026-03-26
tags:
  - "oracle-linux"
  - "ol10"
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/pcp/pcp-Preface.html -->

## Preface

[Oracle Linux 10: Collecting and Analyzing Metrics With Performance Co-Pilot](https://docs.oracle.com/en/operating-systems/oracle-linux/10/pcp/) describes how to install and use Performance Co-Pilot
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/pcp/about_pcp.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/pcp/installing_and_starting_pcp.html -->

## 2 Installing and Starting PCP

Install the `pcp` package, and supplementary tools, on Oracle Linux 10.

Before installing the `pcp-oracle-conf` package, enable the
`ol10_addons` yum repository. For more information, see [Oracle Linux: Managing Software on Oracle
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/pcp/stopping_pcp.html -->
...
restarting disabled system services, see [Oracle Linux 10: System Management with
systemd](https://docs.oracle.com/en/operating-systems/oracle-linux/10/systemd/).


---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/pcp/getting_started_with_pcp.html -->
...
---
<!-- page: https://docs.oracle.com/en/operating-systems/oracle-linux/10/pcp/pcp_command_reference.html -->
